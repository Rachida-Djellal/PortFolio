...
const greeting = {
  ...
  subTitle: emoji(
    "An enthusiastic Full Stack Software Developer 🚀 skilled in crafting  Web ,Desktop and Mobile applications using JavaScript, Java, React.js, Node.js, Angular, Python and various other innovative libraries and frameworks."  ),
  // resumeLink:
...
const skillsSection = {
  ...
  skills: [
    emoji(
      "⚡ Create engaging user interfaces with strong interactivity for your web and mobile applications"
    ),
    emoji("⚡ Architect robust backend systems to power highly interactive front-end user interfaces for both web and mobile applications"),
    emoji("⚡ Implement Behavior-Driven Development (BDD) methodologies to design and develop powerful backend system"),
...
const educationInfo = {
  ...
  schools: [
    ...
    },
    {
      ...
      desc: "Master’s degree in Numerical Prediction Methods in Meteorology"
    }
  ]
};
